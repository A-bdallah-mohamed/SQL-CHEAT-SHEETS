...
--LOG CERTAIN TABLE COLUMNS
select * from user_tab_columns where table_name = 'PLAYERS';

--ALL CONSTRAINTS
SELECT * FROM USER_CONSTRAINTS;
--CERTAIN TABLE CONSTRAINTS
SELECT * FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'PLAYERS';
--LOG COLUMN CONSTRAINT NAME
SELECT * FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'PLAYERS';


--LOG ALL OBJECTS WITH ONLY OBJECT_NAME, OBJECT_TYPE ("BIN$ ARE DELETED OBJECTS CAN BE RESTORED")
SELECT * FROM USER_CATALOG;


--changing date format in the whole session
ALTER SESSION SET NLS_DATE_FORMAT = 'YYYY-MM-DD HH12:MI:SS AM';
